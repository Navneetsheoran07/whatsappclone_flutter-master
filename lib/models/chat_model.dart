...
List<ChatModel> chatData = [
  ...
  ChatModel(
    name: "Shukla Ji",
    message: "Nahi aaj nahi ho payega",
    time: "23:20",
    avatar: "images/shukla.jpg",
  ),
  ChatModel(
    name: "Raj",
    message: "nahi nahi nahi",
    time: "2:20", avatar: "images/shukla.jpg",
  ),
  ChatModel(
    name: "Sachin",
    message: "kal se Cricket Band",
    time: "21:20",
    avatar: "images/sachin.jpg",
  ),
  ChatModel(
    name: "Jay",
    message: "Yes ho jayega",
    time: "21:20", avatar: "images/shukla.jpg",
  ),
  ChatModel(
    name: "Iti Kumari",
    message: "Same here",
  ...
  ChatModel(
    name: "Kabir",
    message: "bhaw bhaw bhaw bada bhaw bhaw",
    time: "21:20", avatar: "images/shukla.jpg",
  ),
];
